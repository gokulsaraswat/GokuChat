...
import com.example.gokuchat.adapters.ChatAdapter;
import com.example.gokuchat.databinding.ActivityChatBinding;
import com.example.gokuchat.models.ChatMessage;
import com.example.gokuchat.models.User;
import com.example.gokuchat.network.ApiClient;
import com.example.gokuchat.network.ApiService;
...
public class ChatActivity extends BaseActivity {
    ...
    private void sendMessage() {
        ...
        if(!isReceiverAvailable){
            try{
                ...
                sendNotification(body.getString(body.toString()));
    ...
    private void addConversion(HashMap<String,Object>conversion){
        database.collection(Constants.KEY_COLLECTION_CONVERSTAIONS)
                .add(conversion)
