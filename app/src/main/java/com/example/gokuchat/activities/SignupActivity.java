...
import com.example.gokuchat.databinding.ActivitySignUpBinding;
...
public class SignupActivity extends AppCompatActivity {
    //Similarly Activity Sign up Binding class auto gen from our layout file : activity sign up
    ...
    private Boolean isValidSignUpDetails(){
        ...
        if(encodedImage == null){
            ...
            showToast("Password & Confirmed Must be same");
            return false;
        }
        else {
            return true;
